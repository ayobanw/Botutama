...
IMAGE_URL = "https://raw.githubusercontent.com/AyobANW/anwbotUtama/main/anwbot.jpg"
...
def start(msg):
    # KHAS: Owner (kau) terus lepas masuk menu. User lain wajib join.
...
# --- SEMUA LIST DATA ASAL KAU (Dah Masukkan Balik Semua) ---
